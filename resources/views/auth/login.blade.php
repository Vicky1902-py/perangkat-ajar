            ...
            <div class="luxury-header">
                @if(app_logo_url())
                    <div class="text-center mb-2">
                        <img src="{{ app_logo_url() }}" alt="{{ app_setting('app_name') }}" style="max-height: 52px; max-width: 160px; object-fit: contain;">
                    </div>
                @else
                ...
                @endif
                <h3 class="system-title">{{ app_setting('app_name', 'Sistem Perangkat Ajar') }}</h3>
                <p class="system-subtitle">
                    {{ app_setting('app_tagline', 'Kurikulum Merdeka SMK • Pendekatan Deep Learning') }}
                </p>
                <div>
