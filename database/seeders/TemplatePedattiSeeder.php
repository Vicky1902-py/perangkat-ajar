...
4. Guru mengajukan pertanyaan pemantik untuk menggali kompetensi awal peserta didik.
5. Guru menyampaikan tujuan pembelajaran, skenario aktivitas alur PEDATTI, serta manfaat langsung materi bagi kesiapan dunia kerja SMK (Menggembirakan/Joyful).',
            ...
            [
                'tahap' => 'dalami',
                'template_kegiatan' => '1. Peserta didik secara aktif membaca stimulus materi dan panduan konsep pada bahan ajar digital (Olah Pikir).
2. Guru memfasilitasi eksplorasi konsep esensial melalui demonstrasi interaktif / studi komparasi kasus terstruktur.
3. Peserta didik berkolaborasi dalam kelompok kecil heterogen mendiskusikan prinsip kerja, arsitektur, atau formulasi pemecahan masalah (Olah Rasa & Kolaborasi).
4. Guru melakukan observasi formatif berkelanjutan untuk mengidentifikasi tingkat pemahaman dan memberikan scaffolding bagi kelompok yang membutuhkan diferensiasi.',
            ...
            [
                'tahap' => 'terapkan',
                'template_kegiatan' => '1. Peserta didik menerima Lembar Kerja Peserta Didik (LKPD) berbasis proyek atau skenario problem-solving industri (Olah Raga/Kinestetik Praktik).
...
3. Peserta didik melakukan self-test dan debugging secara mandiri untuk menguji validitas hasil kerja mereka.
...
3. Peserta didik menyintesis perbedaan variasi solusi antarkelompok untuk memperkaya wawasan bersama (Olah Hati - Saling Menghargai Karya).
4. Guru mengklarifikasi miskonsepsi dan memberikan penguatan konsep secara komprehensif.',
            ...
            [
                'tahap' => 'inovasi',
                'template_kegiatan' => '1. Peserta didik ditantang merumuskan modifikasi inovatif atau studi pengembangan fitur baru di luar spesifikasi dasar (Olah Pikir - Kreativitas).
2. Peserta didik bersama guru melakukan refleksi mendalam (3 pertanyaan reflektif: Apa yang saya pahami? Apa tantangan tersulit? Bagaimana penerapannya di masa depan?).
